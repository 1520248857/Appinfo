...
<div class="row">
	...
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="/app/manager/backend/app/list">
								...
								<c:forEach var="appInfo" items="${appInfoList.list }" varStatus="status">
									<tr role="row" class="odd">
										...
										<button type="button" class="btn btn-default checkApp"
												<%--传到applist.js中的window.location.href="check?aid="+ obj.attr("appinfoid") + "&vid="+ obj.attr("versionid")--%>
				...
				<div class="row">
					...
					<div class="col-sm-7">
						<div class="dataTables_paginate paging_simple_numbers"
							...
							<ul class="pagination">
								<c:if test="${appInfoList.hasPreviousPage}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${appInfoList.prePage});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
								</c:if>
								<c:if test="${appInfoList.hasNextPage}">
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${appInfoList.nextPage});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
									</li>
